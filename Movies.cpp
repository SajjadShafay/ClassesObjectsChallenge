...
* Otherwise, create a movie object from the provided information and 
* add that movie object to the movies vector and return true
***************************************************************************/
bool Movies::add_movie(std::string name, std::string rating, int watched) {
    //you implement this method
    for (auto const &c: movies) 
        if (c.get_name() == name) 
            return false; 
...
/*************************************************************************
* increment_watched expects the name of the move to increment 
* the watched count
* 
* It will search the movies vector to see if a movie object already exists
* with the same name. 
...
* 
* Otherwise, return false since then no movie sobject with the movie
...
* for each movie call the movie.display method so the movie object
* displays itself
**************************************************************************/
